                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <div className="space-y-8">
                        <p className="text-lg font-light text-gray-300 leading-relaxed border-l-2 border-emerald-500/30 pl-6 py-2">
                            We've sourced the data, done the due diligence and built a platform that empowers you to make 10x the returns. Step in.
                        </p>
                    </div>
                </div>
                ...
                <div className="w-full max-w-[400px] space-y-8">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-gray-400 font-light">
                            {isSignUp ? 'Sign up to access the platform' : 'Sign in to access your investor dashboard'}
                        </p>
                    </div>
